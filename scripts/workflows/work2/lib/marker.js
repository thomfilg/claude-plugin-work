/**
 * Marker file management for /work2 session detection.
 *
 * The marker file (.work2-orchestrator.pid) enables hooks to detect
 * active /work2 sessions without relying on session_id matching.
 */
