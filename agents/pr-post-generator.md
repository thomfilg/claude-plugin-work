...
```markdown
## Visual Documentation
See [APPSUPEN-XXX Screenshots](https://github.com/REPO/wiki/APPSUPEN-XXX) for visual verification of the feature.
...
- Error: No screenshots found in /home/node/worktrees/tasks/APPSUPEN-123/screenshots/
