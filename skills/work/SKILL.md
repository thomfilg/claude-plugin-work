...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/workflows/work/work.workflow.js "$ARGUMENTS"
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/workflows/work/work.workflow.js <TICKET_ID> [--rework]
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/workflows/work/work.workflow.js transition PROJ-XXX <target_step>
```
...
```bash
node ${CLAUDE_PLUGIN_ROOT}/scripts/workflows/work/work.workflow.js PROJ-XXX
```
