...
# Folder names follow pattern: ${my_repository_main_worktree_folder}-APPSUPEN-XXX
branch=$(git branch --show-current)
...
```bash
# Branch names follow pattern: APPSUPEN-XXX-description
task_id=$(echo "$branch_name" | grep -oE 'APPSUPEN-[0-9]+')
```
...
- `issue_key`: The Jira task ID (e.g., APPSUPEN-123)
...
─────────────────────────────────────────
1. APPSUPEN-123 - Feature description
...
─────────────────────────────────────────
1. APPSUPEN-456 - Already in Testing/Done
2. APPSUPEN-789 - No matching transition available

FAILED:
─────────────────────────────────────────
1. APPSUPEN-999 - Transition not allowed from current status
```
...
1. origin/APPSUPEN-123-feature-name
...
1. origin/APPSUPEN-456-active-work
