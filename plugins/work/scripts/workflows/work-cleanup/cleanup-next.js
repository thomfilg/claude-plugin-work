...
/**
 * cleanup-next.js — thin wrapper over the shared phase-runner factory.
 *
...
const main = createPhaseRunner({
  ...
  phaseStateCliPath: path.resolve(__dirname, 'cleanup-phase-state.js'),
  initialPhase: CLEANUP_INITIAL_PHASE,
  getPhase,
  usageHint: 'usage: cleanup-next.js <TICKET>\n  e.g. node cleanup-next.js ECHO-4579',
});
