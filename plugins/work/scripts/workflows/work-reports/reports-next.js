...
/**
 * reports-next.js — thin wrapper over the shared phase-runner factory.
 *
...
const main = createPhaseRunner({
  ...
  phaseStateCliPath: path.resolve(__dirname, 'reports-phase-state.js'),
  initialPhase: REPORTS_INITIAL_PHASE,
  getPhase,
  usageHint: 'usage: reports-next.js <TICKET>\n  e.g. node reports-next.js ECHO-4579',
});
