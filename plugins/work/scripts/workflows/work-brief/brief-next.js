...
/**
 * brief-next.js — thin wrapper over the shared phase-runner factory.
 *
...
const main = createPhaseRunner({
  ...
  phaseStateCliPath: path.resolve(__dirname, 'brief-phase-state.js'),
  initialPhase: BRIEF_INITIAL_PHASE,
  getPhase,
  usageHint: 'usage: brief-next.js <TICKET>\n  e.g. node brief-next.js ECHO-4560',
});
