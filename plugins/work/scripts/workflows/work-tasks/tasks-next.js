...
/**
 * tasks-next.js — thin wrapper over the shared phase-runner factory.
 *
...
const main = createPhaseRunner({
  ...
  phaseStateCliPath: path.resolve(__dirname, 'tasks-phase-state.js'),
  initialPhase: TASKS_INITIAL_PHASE,
  getPhase,
  usageHint: 'usage: tasks-next.js <TICKET>\n  e.g. node tasks-next.js ECHO-4579',
});
