...
/**
 * qa-next.js — thin wrapper over the shared phase-runner factory.
 *
...
const main = createPhaseRunner({
  ...
  phaseStateCliPath: path.resolve(__dirname, 'qa-phase-state.js'),
  initialPhase: QA_INITIAL_PHASE,
  getPhase,
  usageHint: 'usage: qa-next.js <TICKET>\n  e.g. node qa-next.js ECHO-4579',
});
