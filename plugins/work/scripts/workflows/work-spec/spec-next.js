...
/**
 * spec-next.js — thin wrapper over the shared phase-runner factory.
 *
...
const main = createPhaseRunner({
  ...
  phaseStateCliPath: path.resolve(__dirname, 'spec-phase-state.js'),
  initialPhase: SPEC_INITIAL_PHASE,
  getPhase,
  usageHint: 'usage: spec-next.js <TICKET>\n  e.g. node spec-next.js ECHO-4579',
});
