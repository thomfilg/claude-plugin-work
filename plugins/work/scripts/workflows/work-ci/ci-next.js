...
/**
 * ci-next.js — thin wrapper over the shared phase-runner factory.
 *
...
const main = createPhaseRunner({
  ...
  phaseStateCliPath: path.resolve(__dirname, 'ci-phase-state.js'),
  initialPhase: CI_INITIAL_PHASE,
  getPhase,
  usageHint: 'usage: ci-next.js <TICKET>\n  e.g. node ci-next.js ECHO-4579',
});
